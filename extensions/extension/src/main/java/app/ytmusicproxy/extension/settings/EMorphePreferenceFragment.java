...
public final class EMorphePreferenceFragment extends CustomPreferenceFragmentCompat {
    @Override
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        int resourceId = context.getResources().getIdentifier("emorphe_settings", "xml", context.getPackageName());
        if (resourceId != 0) {
